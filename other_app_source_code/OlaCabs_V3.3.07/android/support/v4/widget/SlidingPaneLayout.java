...
public class SlidingPaneLayout extends ViewGroup {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.height == -2) {
                    i8 = MeasureSpec.makeMeasureSpec(mode2, ExploreByTouchHelper.INVALID_ID);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mFirstLayout) {
            float f = (this.mCanSlide && this.mPreservedOpenState) ? br.DEFAULT_BACKOFF_MULT : 0.0f;
            this.mSlideOffset = f;
        }
        int i6 = 0;
        int i7 = paddingRight;
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i8 = (int) ((br.DEFAULT_BACKOFF_MULT - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i10 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i9 = (i5 - i10) + i8;
    ...
    private boolean openPane(View view, int i) {
        if (!this.mFirstLayout && !smoothSlideTo(br.DEFAULT_BACKOFF_MULT, i)) {
            return false;
        }
    ...
    public boolean isOpen() {
        return !this.mCanSlide || this.mSlideOffset == br.DEFAULT_BACKOFF_MULT;
    }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt == this.mSlideableView) {
                        i2 = (int) ((br.DEFAULT_BACKOFF_MULT - this.mParallaxOffset) * ((float) this.mParallaxBy));
                        this.mParallaxOffset = f;
                        i2 -= (int) ((br.DEFAULT_BACKOFF_MULT - f) * ((float) this.mParallaxBy));
                        if (isLayoutRtlSupport) {
                            i2 = -i2;
                        }
                        childAt.offsetLeftAndRight(i2);
                        if (obj == null) {
                            dimChildView(childAt, isLayoutRtlSupport ? this.mParallaxOffset - br.DEFAULT_BACKOFF_MULT : br.DEFAULT_BACKOFF_MULT - this.mParallaxOffset, this.mCoveredFadeColor);
                        }
                    }
                }
            }

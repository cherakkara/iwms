...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mFullUnderlineHeight = (int) ((br.DEFAULT_BACKOFF_MULT * f) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C00661());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C00672());
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        this.mTabAlpha = (int) ((Math.abs(f - 0.5f) * dm.DEFAULT_BACKOFF_MULT) * 255.0f);

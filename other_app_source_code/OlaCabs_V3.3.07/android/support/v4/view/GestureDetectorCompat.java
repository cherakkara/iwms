            ...
            switch (action & MotionEventCompat.ACTION_MASK) {
                ...
                case SHOW_PRESS /*1*/:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(Constants.MILLIS_IN_A_SECOND, (float) this.mMaximumFlingVelocity);
                ...
                case R.SlidingUpPanelLayout_umanoOverlay /*6*/:
                    ...
                    this.mLastFocusY = f;
                    this.mDownFocusY = f;
                    this.mVelocityTracker.computeCurrentVelocity(Constants.MILLIS_IN_A_SECOND, (float) this.mMaximumFlingVelocity);

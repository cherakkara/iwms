...
class ViewPropertyAnimatorCompatICS {
    ...
    public static void m35x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m36y(View view, float f) {
        view.animate().y(f);
    }
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C00761(viewPropertyAnimatorListener, view));
        } else {

...
public class TransportMediator extends TransportController {
    ...
    class C00291 implements TransportMediatorCallback {
        C00291() {
        }
    ...
    class C00302 implements Callback {
        C00302() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C00291();
        this.mKeyEventCallback = new C00302();

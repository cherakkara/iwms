...
public final class RatingCompat implements Parcelable {
    ...
    static class C00281 implements Creator<RatingCompat> {
        C00281() {
        }
    ...
    public static RatingCompat newHeartRating(boolean z) {
        return new RatingCompat(RATING_HEART, z ? br.DEFAULT_BACKOFF_MULT : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean z) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, z ? br.DEFAULT_BACKOFF_MULT : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != br.DEFAULT_BACKOFF_MULT) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == br.DEFAULT_BACKOFF_MULT) {
            return true;
        }
        return false;
    }

...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00311 implements OnWindowAttachListener {
        C00311() {
        }
    ...
    class C00322 implements OnWindowFocusChangeListener {
        C00322() {
        }
    ...
    class C00333 extends BroadcastReceiver {
        C00333() {
        }
    ...
    class C00344 implements OnAudioFocusChangeListener {
        C00344() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new C00311();
        this.mWindowFocusListener = new C00322();
        this.mMediaButtonReceiver = new C00333();
        this.mAudioFocusChangeListener = new C00344();
        this.mPlayState = 0;
    ...
    public void refreshState(boolean z, long j, int i) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(z ? 3 : 1, j, z ? br.DEFAULT_BACKOFF_MULT : 0.0f);

...
public class HttpsURLConnectionExtension extends HttpsURLConnection {
    ...
    /* renamed from: com.newrelic.agent.android.instrumentation.HttpsURLConnectionExtension.1 */
    class C07401 implements StreamCompleteListener {
        final /* synthetic */ TransactionState val$transactionState;

        C07401(TransactionState transactionState) {
        ...
        public void streamComplete(StreamCompleteEvent streamCompleteEvent) {
            if (!this.val$transactionState.isComplete()) {
                ...
                HttpsURLConnectionExtension.this.addTransactionAndErrorData(this.val$transactionState);
            }
        }
    }

    /* renamed from: com.newrelic.agent.android.instrumentation.HttpsURLConnectionExtension.2 */
    class C07412 implements StreamCompleteListener {
        final /* synthetic */ TransactionState val$transactionState;

        C07412(TransactionState transactionState) {
            this.val$transactionState = transactionState;
        }
    ...
    public InputStream getInputStream() throws IOException {
        ...
        try {
            ...
            countingInputStream.addStreamCompleteListener(new C07401(transactionState));
    ...
    public OutputStream getOutputStream() throws IOException {
        ...
        try {
            ...
            countingOutputStream.addStreamCompleteListener(new C07412(transactionState));

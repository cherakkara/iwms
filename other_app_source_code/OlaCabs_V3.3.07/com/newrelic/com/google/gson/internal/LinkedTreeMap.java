...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C07721 implements Comparator<Comparable> {
        C07721() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C07731 extends LinkedTreeMapIterator<Entry<K, V>> {
            C07731() {
                super(null);
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C07741 extends LinkedTreeMapIterator<K> {
            C07741() {
                super(null);
            }

...
public final class Gson {
    ...
    class C07531 implements JsonDeserializationContext {
        C07531() {
        }
    ...
    class C07542 implements JsonSerializationContext {
        C07542() {
        }
    ...
    class C07553 extends TypeAdapter<Number> {
        C07553() {
        }
    ...
    class C07564 extends TypeAdapter<Number> {
        C07564() {
        }
    ...
    class C07575 extends TypeAdapter<Number> {
        C07575() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new C07531();
        this.serializationContext = new C07542();

...
class NativeCrashWriter {
    ...
    private static final class ApplicationMessage extends ProtobufMessage {
        ...
        public ApplicationMessage(ExecutionMessage executionMessage, RepeatedMessage repeatedMessage) {
            super(PROTOBUF_TAG, executionMessage, repeatedMessage);
        }
    }
    ...
    private static final class BinaryImageMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            ...
            return ((computeUInt64Size + CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(this.filePath))) + CodedOutputStream.computeUInt64Size(2, this.imageSize)) + CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.uuid));
        }
        ...
        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.uuid));
        }
    }
    ...
    private static final class CustomAttributeMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            return CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? Trace.NULL : this.value)) + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8(this.key));
        }

        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            codedOutputStream.writeBytes(1, ByteString.copyFromUtf8(this.key));
            codedOutputStream.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? Trace.NULL : this.value));
        }
    }
    ...
    private static final class DeviceMessage extends ProtobufMessage {
        ...
        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.writeUInt64(PROTOBUF_TAG, this.ramUsed);
    ...
    private static final class ExecutionMessage extends ProtobufMessage {
        ...
        public ExecutionMessage(SignalMessage signalMessage, RepeatedMessage repeatedMessage, RepeatedMessage repeatedMessage2) {
            super(PROTOBUF_TAG, repeatedMessage, signalMessage, repeatedMessage2);
        }
    }
    ...
    private static final class FrameMessage extends ProtobufMessage {
        ...
        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.file));
    ...
    private static final class SignalMessage extends ProtobufMessage {
        ...
        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.writeUInt64(PROTOBUF_TAG, this.sigAddr);
        }
    }
    ...
    private static final class ThreadMessage extends ProtobufMessage {
        ...
        public ThreadMessage(ThreadData threadData, RepeatedMessage repeatedMessage) {
            ...
            protobufMessageArr[0] = repeatedMessage;
            super(PROTOBUF_TAG, protobufMessageArr);
        ...
        public int getPropertiesSize() {
            return (hasName() ? CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.name)) : 0) + CodedOutputStream.computeUInt32Size(2, this.importance);
        }

        public void writeProperties(CodedOutputStream codedOutputStream) throws IOException {
            if (hasName()) {
                codedOutputStream.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.name));
            }
    ...
    static {
        DEFAULT_SIGNAL = new SignalData(Trace.NULL, Trace.NULL, 0);

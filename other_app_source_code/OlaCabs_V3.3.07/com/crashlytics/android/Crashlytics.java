...
import p004b.p005a.p006a.p007a.KitGroup;
...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    public static Crashlytics getInstance() {
        return (Crashlytics) Fabric.m504a(Crashlytics.class);
    }
    ...
    public void setDebugMode(boolean z) {
        Fabric.m512h().m479d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        Fabric.m512h().m479d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return Fabric.m513i();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        Fabric.m512h().m479d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }

...
final class Constants {
    ...
    static String ANALYTICS_HOST = null;
    static String BLACKOUT_RULES_KEY = null;
    static String CAMPAIGN_ID_KEY = null;
    static final String CLOSE_EVENT = "close";
    static final String CONDITIONS_KEY = "conditions";
    static final String CONFIG_KEY = "config";
    static String COUNT_KEY = null;
    ...
    static String DATES_KEY = null;
    static String DAYS_KEY = null;
    ...
    static String DISPLAY_FREQUENCIES_KEY = null;
    static String END_KEY = null;
    static final String EVENT_FORMAT = "%s:%s";
    static String FREQUENCY_CAPPING_KEY = null;
    static final String HEIGHT_KEY = "height";
    static String IGNORE_GLOBAL_KEY = null;
    ...
    static String MARKETING_HOST = null;
    ...
    static String MAX_DISPLAY_COUNT_KEY = null;
    ...
    static String PROFILES_HOST = null;
    ...
    static String WEEKDAYS_KEY = null;
    static final String WIDTH_KEY = "width";
    static long dbMaxSizeForAnalytics;
    static long dbMaxSizeForProfiles;
    private static final AtomicBoolean sTestModeEnabled;

    static {
        CURRENT_API_LEVEL = DatapointHelper.getApiLevel();
        sTestModeEnabled = new AtomicBoolean(USE_EXTERNAL_DIRECTORY);
        dbMaxSizeForProfiles = (long) Math.pow(2.0d, 20.0d);
        dbMaxSizeForAnalytics = (long) Math.pow(2.0d, 24.0d);
        SESSION_EXPIRATION = 15000;
        IS_LOGGING_ENABLED = USE_EXTERNAL_DIRECTORY;
        USE_HTTPS = IS_EXCEPTION_SUPPRESSION_ENABLED;
        ...
        TIMES_KEY = "times";
        IGNORE_GLOBAL_KEY = "ignore_global";
    }

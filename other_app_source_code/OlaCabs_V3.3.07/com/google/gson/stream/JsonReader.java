...
public class JsonReader implements Closeable {
    ...
    static class C05981 extends JsonReaderInternalAccess {
        C05981() {
        }

        public void promoteNameToValue(JsonReader jsonReader) throws IOException {
            if (jsonReader instanceof JsonTreeReader) {
                ((JsonTreeReader) jsonReader).m12055a();
                return;
            }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new C05981();
    }

    public JsonReader(Reader reader) {
        this.lenient = false;
        this.buffer = new char[Defaults.RESPONSE_BODY_LIMIT];

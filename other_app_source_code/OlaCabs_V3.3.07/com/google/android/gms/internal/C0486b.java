...
public final class C0486b {
    public static Bitmap m4049a(Bitmap bitmap) {
        int i = 0;
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m4050a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m4051a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, C0486b.m4049a(C0486b.m4050a(drawable)));
    }
}

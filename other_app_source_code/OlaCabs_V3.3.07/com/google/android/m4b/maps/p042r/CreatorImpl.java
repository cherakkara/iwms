...
/* renamed from: com.google.android.m4b.maps.r.q */
public class CreatorImpl extends ICreator {
    public final void m11201a(IObjectWrapper iObjectWrapper) {
        m11202a(iObjectWrapper, 0);
    }

    public final void m11202a(IObjectWrapper iObjectWrapper, int i) {
    ...
    public final IStreetViewPanoramaViewDelegate m11199a(IObjectWrapper iObjectWrapper, StreetViewPanoramaOptions streetViewPanoramaOptions) {
        Context context = (Context) ObjectWrapper.m10131a(iObjectWrapper);
        CreatorImpl.m11197a(context);
        return new aw(context, streetViewPanoramaOptions);
    }

    public final ICameraUpdateFactoryDelegate m11200a() {
        return new bq();
    }

    public final IBitmapDescriptorFactoryDelegate m11203b() {
        return new bj();
    }

    private static void m11197a(Context context) {
        try {
